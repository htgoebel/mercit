...
#+texinfo_dir_title: Magit-Section: (mercit-section).
...
user options see [[info:mercit#Sections]].  This manual documents how you
...
and user options see [[info:mercit#Sections]].  This manual documents
...
- Macro: mercit-insert-section [name] (type &optional value hide) &rest body ::
...
- Macro: mercit-insert-section-body &rest body ::
...
- Function: mercit-wash-sequence function ::
...
- Function mercit-section-at &optional position ::
...
- Function: mercit-section-ident-value value ::

  Return a constant representation of VALUE.

  VALUE is the value of a ~mercit-section~ object.  If that is an
...
- Function: mercit-section-lineage section ::

  Return the lineage of SECTION.
  The return value has the form ~(TYPE...)~.

- Function: mercit-section-content-p section ::
...
have the same name except for the ~mercit-~ prefix.  Like
~mercit-current-section~ they do not act on point, the cursors position,
...
- Function mercit-thing-at-point thing &optional no-properties ::
...
- Function: mercit-section-match condition &optional (section (mercit-current-section)) ::
...
- Macro: mercit-section-case &rest clauses ::
...
#  LocalWords:  alist eval featurep ident keymap mercit ol
